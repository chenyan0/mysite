$(function(){
    ...
    $(".web-more").click(function () {
        if(flag1){
            $(".one>.wf-list").removeClass("scale2");
            $(".one>.wf-list").addClass("scale1");
            setTimeout(function () {
                $(".two").css({zIndex:2});
                $(".one").css({zIndex:0});
                $(".two>.wf-list").addClass("scale2");
                flag1=false;
            },1000)
        }else{
            $(".two>.wf-list").removeClass("scale2");
            $(".two>.wf-list").addClass("scale1");
            $(".one").css({zIndex:2});
            $(".two").css({zIndex:0});
            setTimeout(function () {
                $(".one>.wf-list").addClass("scale2");
            },1000)
